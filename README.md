...
- Navigate to `ToyotaAssistant` folder
- Select `ToyotaAssistant.bot` file
...
msbot clone services --name "ToyotaAssistant" --code-dir "." --location <azure region like eastus, westus, westus2 etc.> --sdkLanguage "Node" --folder deploymentScripts/msbotClone --verbose
```
